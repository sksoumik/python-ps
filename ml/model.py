    ...
    def train(self):
        ...
        if self.parser.validation:
            datagen = tf.keras.preprocessing.image.ImageDataGenerator(
                ...
                featurewise_std_normalization=self.parser.featurewise_std_normalization,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-fsn', '--featurewise_std_normalization', default=False)
    parser.add_argument('-v', '--validation', default=True)
    parser.add_argument('-vs', '--validation_split', default=.20)
    parser.add_argument('-dir', '--input_directory',
